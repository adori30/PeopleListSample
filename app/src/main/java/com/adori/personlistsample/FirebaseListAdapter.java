...
*/
     ...
     * @param key The key used to index this particular model
     */
    protected abstract void populateView(VH viewHolder, T model, String key);
}